...
import myImage0 from "../../assets/svgs/filter-icon.svg";
import myImage from "../../assets/images/coach-1.png";
import myImage1 from "../../assets/images/coach-2.png";
import myImage2 from "../../assets/images/coach-3.png";
      ...
      <div style={{ marginTop: "10%" }}>
        <div className="gameAndCoachId">
          <button
            type="button"
            style={{
              backgroundColor: "rgba(37, 91, 155, 1)",
              borderRadius: "10px",
              height: "35px",
          ...
          <div className="card-chatcard">
            ...
            <div className="secondPartRight">
              ...
              <div className="partSb">
                <Link to="/coachChat">
                  <button className="buttonStyle1">Chat Now</button>
                </Link>
                <Link>
                  <button className="buttonStyle2" onClick={CallNow}>
                    Call Now
                  </button>
                </Link>
              </div>
          ...
          <div className="card-chatcard">
            ...
            <div className="secondPartRight">
              ...
              <div className="partSb">
                ...
                <Link to="/Coach-video-chat">
                  <button className="buttonStyle2">Call Now</button>
                </Link>
              </div>
            </div>
          </div>
