      ...
      <div className="content">
        <div className="row">
          ...
          <div className="column-02">
            <img src="football-card@2x.png" alt="img1"  width="400px" />
          </div>
        </div>
        <div className="row1">
       <Link to="/Landing-Page">   <img src="football-card@2x.png" alt="img1" width="15%" /></Link>
      <Link to="/Landing-Page3">    <img src="basketball-card1@2x.png" alt="img1" width="13%" /></Link>
      <Link to="/Landing-Page2">    <img src="tennis-card1@2x.png" alt="img1" width="12%" /></Link>
      <Link to="/Landing-Page4">     <img src="yoga-card1@2x.png" alt="img1" width="11%" /></Link>
